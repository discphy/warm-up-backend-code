...
현재 날짜(3월 17일) 기준으로 **Day 16 미션과 3주 차 발자국**을 작성 중이며,   
이번 주 안에 **Day 18 미션과 4주 차 발자국**도 작성을 완료하는 것이 목표이다.   
(~~가능할지는 모르겠지만 ㅎㅎ~~)
...
나는 위의 이미지처럼 [Trello](https://trello.com/)를 활용해 인프런 워밍업 클럽에 참여하고 있다.  
